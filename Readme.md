...
2. Start Ganache, create a new workspace and link the truffle project to it 
3. In the project directory, run `npm install --save truffle-assertions`. This package is required to smoothely run the JavaScript test cases
